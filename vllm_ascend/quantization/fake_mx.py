...
def _amct_quantize_elementwise(
    ...
    rounded = _amct_round(value / private_scale * shift)
...
def _fake_mx_quantize_reference(
    ...
    quantized = _amct_quantize_elementwise(clipped / scale, min_exponent, max_normal, shift)
...
def maybe_fake_mx_quantize_attention_qkv(
    ...
    quantized = maybe_fake_mx_quantize_activations(qkv_projection, query, key, value, target="attn-cache")
