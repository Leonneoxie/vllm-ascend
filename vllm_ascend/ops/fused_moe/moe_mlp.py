...
def unquant_apply_mlp(
    ...
    if fake_mx_algorithm == "hadamard_learning":
        ...
        hidden_states = fake_mx_quantize(hidden_states, fake_mx_format, fake_mx_group_size)
    ...
    if fake_mx_format is not None:
        gate_up_out = fake_mx_quantize(gate_up_out, fake_mx_format, fake_mx_group_size)
